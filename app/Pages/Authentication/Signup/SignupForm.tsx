  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      if (auth) {
        ...
        console.log('User signed up:', { displayName: `${firstName} ${lastName}`, email });
        ...
        console.log('Mock signup:', { displayName: `${firstName} ${lastName}`, email });
          ...
          {initialLoading ? (
            ...
            <>
              <Group grow mb="md" mt="md">
                <GoogleButton radius="xs">Google</GoogleButton>
                <TwitterButton radius="xs">Twitter</TwitterButton>
              </Group>
