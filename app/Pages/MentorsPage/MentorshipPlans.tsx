...
// import 'react-datepicker/dist/react-datepicker.css'; // Removed - date package hidden
// import DatePicker from 'react-datepicker'; // Removed - date package hidden

import { ContentContext, ContentProvider } from '../../context/ContentContext.tsx';
import { useRouter } from "next/navigation";

import { IconCalendarDue, IconClock, IconUser, IconTopologyStar, IconMail, IconPhone, IconChevronLeft, IconChevronRight } from '@tabler/icons-react';
// import { Calendar } from '@mantine/dates'; // Removed - dates package uninstalled
// import '@mantine/dates/styles.css'; // Removed - dates package uninstalled
// import dayjs from 'dayjs'; // Removed - dates package uninstalled
...
const MentorshipPlans = ({data}) => {
  ...
  const handleSubmit = () => {
    ...
    router.push('/mentors/payment', { state: { paymentDetails: newPaymentOption } });
  };
                ...
                <Card.Section withBorder inheritPadding py="xl">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-3 gap-3">
                      {availableTimeSlots
                        .filter(slot => !slot.date || slot.date === selectedDate?.toISOString().split('T')[0]) // Ensure slots are filtered correctly
                        .map((slot) => (
                          <Button
