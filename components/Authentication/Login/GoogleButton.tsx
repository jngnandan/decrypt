...
// import { onAuthStateChanged, signInWithPopup, GoogleAuthProvider } from 'firebase/auth'; // Temporarily disabled
...
export default function GoogleButton(props: ButtonProps & React.ComponentPropsWithoutRef<'button'>) {
  ...
  return <Button leftSection={<GoogleIcon />} variant="default" onClick={handleClick} loading={loading} {...props} />;
}